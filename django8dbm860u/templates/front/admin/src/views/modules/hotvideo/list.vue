<template>
	<div class="main-content" :style='{"padding":"0","fontSize":"15px"}'>
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 10px 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","background":"#fff","display":"block"}' >
					...
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">up主</label>
						<el-input v-model="searchForm.author" placeholder="up主" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						...
						<el-input v-model="searchForm.typename" placeholder="类型" @keydown.enter.native="search()" clearable></el-input>
					</div>
				...
				<el-row class="actions" :style='{"padding":"0","margin":"30px 0","flexWrap":"wrap","background":"transparent","display":"flex"}'>
					<el-button class="add" v-if="isAuth('hotvideo','新增')" type="success" @click="addOrUpdateHandler()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						添加
					</el-button>
					<el-button class="del" v-if="isAuth('hotvideo','删除')" :disabled="dataListSelections.length?false:true" type="danger" @click="deleteHandler()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						删除
					</el-button>


					<el-button class="btn18" v-if="isAuth('hotvideo','爬取数据')" type="success" @click="spider()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						爬取数据
					</el-button>
					<el-button class="btn18" v-if="isAuth('hotvideo','视频时长')" type="success" @click="chartDialog1()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						视频时长
					</el-button>
					<el-button class="btn18" v-if="isAuth('hotvideo','视频播放量')" type="success" @click="chartDialog2()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						视频播放量
					</el-button>
					<el-button class="btn18" v-if="isAuth('hotvideo','视频弹幕量')" type="success" @click="chartDialog3()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						视频弹幕量
					</el-button>
					<el-button class="btn18" v-if="isAuth('hotvideo','视频点赞量')" type="success" @click="chartDialog4()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						视频点赞量
					</el-button>
					<el-button class="btn18" v-if="isAuth('hotvideo','视频收藏量')" type="success" @click="chartDialog5()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						视频收藏量
					</el-button>
					<el-button class="btn18" v-if="isAuth('hotvideo','视频分享量')" type="success" @click="chartDialog6()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						视频分享量
					</el-button>
					<el-button class="btn18" v-if="isAuth('hotvideo','视频投币量')" type="success" @click="chartDialog7()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						视频投币量
					</el-button>
					<el-button class="btn18" v-if="isAuth('hotvideo','UP主类型')" type="success" @click="chartDialog8()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						UP主类型
					</el-button>
					<el-button class="btn18" v-if="isAuth('hotvideo','视频类型')" type="success" @click="chartDialog9()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						视频类型
					</el-button>
				</el-row>
			...
			<div :style='{"width":"100%","padding":"0 10px","fontSize":"14px","color":"#000"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column  :resizable='true' prop="cover" width="200" label="封面">
						<template slot-scope="scope">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button class="view" v-if=" isAuth('hotvideo','查看')" type="success" @click="addOrUpdateHandler(scope.row.id,'info')">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								查看
							</el-button>
							<el-button class="edit" v-if=" isAuth('hotvideo','修改') " type="success" @click="addOrUpdateHandler(scope.row.id)">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								修改
							</el-button>

							<el-button class="view" v-if="isAuth('hotvideo','查看评论')" type="success" @click="disscussListHandler(scope.row.id)">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								查看评论
							</el-button>
							...
							<el-button class="del" v-if="isAuth('hotvideo','删除') " type="primary" @click="deleteHandler(scope.row.id )">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								删除
							</el-button>
						</template>
		...
		<el-dialog
			...
			width="800">
			<div id="durationChart1" style="width:100%;height:600px;"></div>
		...
		<el-dialog
			...
			width="800">
			<div id="playcountChart2" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="danmakuChart3" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="likesChart4" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="favoriteChart5" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="shareChart6" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="coinChart7" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="authorChart8" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="typenameChart9" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
	...
	export default {
		...
		methods: {
			...
			chartDialog1() {
				...
				this.$nextTick(()=>{
					var durationChart1 = echarts.init(document.getElementById("durationChart1"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							durationChart1.setOption(option);
							  //根据窗口的大小变动图表
							window.onresize = function() {
								durationChart1.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog2() {
				...
				this.$nextTick(()=>{
					...
					var playcountChart2 = echarts.init(document.getElementById("playcountChart2"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							playcountChart2.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								playcountChart2.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog3() {
				...
				this.$nextTick(()=>{
					...
					var danmakuChart3 = echarts.init(document.getElementById("danmakuChart3"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							danmakuChart3.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								danmakuChart3.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog4() {
				...
				this.$nextTick(()=>{
					...
					var likesChart4 = echarts.init(document.getElementById("likesChart4"),'macarons');
					this.$http({
			...
			chartDialog5() {
				...
				this.$nextTick(()=>{
					...
					var favoriteChart5 = echarts.init(document.getElementById("favoriteChart5"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							favoriteChart5.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								favoriteChart5.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog6() {
				...
				this.$nextTick(()=>{
					...
					var shareChart6 = echarts.init(document.getElementById("shareChart6"),'macarons');
					this.$http({
			...
			chartDialog7() {
				...
				this.$nextTick(()=>{
					...
					var coinChart7 = echarts.init(document.getElementById("coinChart7"),'macarons');
					this.$http({
			...
			chartDialog8() {
				...
				this.$nextTick(()=>{
					...
					var authorChart8 = echarts.init(document.getElementById("authorChart8"),'macarons');
					this.$http({
			...
			chartDialog9() {
				...
				this.$nextTick(()=>{
					...
					var typenameChart9 = echarts.init(document.getElementById("typenameChart9"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							typenameChart9.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								typenameChart9.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			getDataList() {
				...
				let params = {
 				...
 				if(this.searchForm.author!='' && this.searchForm.author!=undefined){
			...
			disscussListHandler(id,type) {
				this.$router.push({path:'/discusshotvideo',query:{refid:id}});
			},
			// 删除
