		...
		<div :style='{"padding":"20px","flex":"auto","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"0","zIndex":"2"}'>
			<div :style='{"width":"25%","padding":"0","flexDirection":"column","background":"none","display":"flex","gap":"10px"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="hotvideoChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"padding":"0 0 0 45px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) center center/100% 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="hotvideoChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="hotvideoChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"padding":"0 0 10px 0","margin":"0","color":"#fff","alignItems":"center","background":"none","display":"flex","gap":"10px","width":"100%","fontSize":"14px","justifyContent":"space-evenly","height":"84px"}'>
					...
					<div :style='{"margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250104/f33d5d50e8f84eca902cf5cfcbf23edf.png) center center/100% 100%","flexDirection":"column","flex":"0 1 auto","display":"flex","width":"175px","position":"relative","justifyContent":"center","height":"100%","maxWidth":"175px"}'>
						...
						<div :style='{"padding":"0","alignItems":"center","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"100%"}'>
							...
							<div :style='{"lineHeight":"24px","fontSize":"16px","color":"rgb(30, 144, 255)","fontWeight":"bold","height":"24px","order":"20"}'>{{yonghuCount}}</div>
						</div>
					</div>
					...
					<div :style='{"margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250104/f33d5d50e8f84eca902cf5cfcbf23edf.png) center center/100% 100%","flexDirection":"column","flex":"0 1 auto","display":"flex","width":"175px","position":"relative","justifyContent":"center","height":"100%","maxWidth":"200px"}'>
						<div :style='{"width":"12px","margin":"0","background":"#2097db","display":"none","height":"12px"}'></div>
						<div :style='{"padding":"0","alignItems":"center","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"100%"}'>
							<div :style='{"lineHeight":"24px","fontSize":"12px","position":"relative","color":"inherit","height":"24px"}'>热门视频总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"16px","color":"rgb(246, 192, 12)","fontWeight":"bold","height":"24px","order":"20"}'>{{hotvideoCount}}</div>
						</div>
					</div>
					...
					<div :style='{"margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250104/f33d5d50e8f84eca902cf5cfcbf23edf.png) center center/100% 100%","flexDirection":"column","flex":"0 1 auto","display":"flex","width":"175px","position":"relative","justifyContent":"center","height":"100%","maxWidth":"200px"}'>
						<div :style='{"width":"12px","margin":"0","background":"#2097db","display":"none","height":"12px"}'></div>
						<div :style='{"padding":"0","alignItems":"center","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"100%"}'>
							<div :style='{"lineHeight":"24px","fontSize":"12px","position":"relative","color":"inherit","height":"24px"}'>热门视频预测总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"16px","color":"#00fbff","fontWeight":"bold","height":"24px","order":"20"}'>{{hotvideoforecastCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts7">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="hotvideoChart7" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts8">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="hotvideoChart8" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts9">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="hotvideoChart9" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts10">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<el-table id="hotvideoTable" :data="hotvideoList" border :stripe="true" :style='{"padding":"0","borderColor":"#eee","overflow":"auto","borderWidth":"0","background":"none","width":"100%","borderStyle":"solid","height":"calc(100% - 65px)"}'>
						...
						<el-table-column :resizable="true" :sortable="false" prop="cover" label="封面">
							<template slot-scope="scope">
								<div v-if="scope.row.cover">
									<img v-if="scope.row.cover.substring(0,4)=='http'&&scope.row.cover.split(',w').length>1" :src="scope.row.cover" width="30" height="30">
									<img v-else-if="scope.row.cover.substring(0,4)=='http'" :src="scope.row.cover.split(',')[0]" width="30" height="30">
									<img v-else :src="$base.url+scope.row.cover.split(',')[0]" width="30" height="30">
								</div>
								<div v-else>无图片</div>
							</template>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="author" label="up主"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="typename" label="类型"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="laiyuan" label="来源"/>
						</el-table-column>
					</el-table>
				</div>
				<div class="forecast-box" :style='{"border":"none","padding":"20px","margin":"0","flexWrap":"wrap","background":"none","flex":"0 0 auto","display":"flex","width":"20%","transition":"0.3s","height":"calc(40% - 42px)","order":"10"}'>
					<div :style='{"border":"1px solid #999","padding":"0 10px","margin":"0 0 10px 0","alignItems":"center","display":"flex","width":"100%","order":"2"}'>
						...
						<input :style='{"border":"none","padding":"0 10px","margin":"0","color":"rgb(30, 144, 255)","background":"none","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.title" placeholder="请输入标题"></input>
					</div>
					<div :style='{"border":"1px solid #999","padding":"0 10px","margin":"0 0 10px 0","alignItems":"center","display":"flex","width":"100%","order":"2"}'>
						<div :style='{"width":"auto","color":"#999","textAlign":"left","order":"1"}'>
							时长（秒）
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","color":"rgb(30, 144, 255)","background":"none","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.duration" placeholder="请输入时长（秒）"></input>
					</div>
					<div :style='{"border":"1px solid #999","padding":"0 10px","margin":"0 0 10px 0","alignItems":"center","display":"flex","width":"100%","order":"2"}'>
						<div :style='{"width":"auto","color":"#999","textAlign":"left","order":"1"}'>
							up主
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","color":"rgb(30, 144, 255)","background":"none","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.author" placeholder="请输入up主"></input>
					</div>
					<div :style='{"border":"1px solid #999","padding":"0 10px","margin":"0 0 10px 0","alignItems":"center","display":"flex","width":"100%","order":"2"}'>
						<div :style='{"width":"auto","color":"#999","textAlign":"left","order":"1"}'>
							类型
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","color":"rgb(30, 144, 255)","background":"none","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.typename" placeholder="请输入类型"></input>
					</div>
					<div :style='{"border":"1px solid #999","padding":"0 10px","margin":"0 0 10px 0","alignItems":"center","display":"flex","width":"100%","order":"2"}'>
						<div :style='{"width":"auto","color":"#999","textAlign":"left","order":"1"}'>
							投币
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","color":"rgb(30, 144, 255)","background":"none","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.coin" placeholder="请输入投币"></input>
					</div>
					<div :style='{"width":"100%","fontSize":"16px","lineHeight":"40px","color":"rgb(30, 144, 255)","textAlign":"left"}'>
						预测播放量：{{form.playcount}}
					</div>
			...
			<div :style='{"padding":"0","flexWrap":"wrap","flexDirection":"column","background":"none","display":"flex","gap":"10px","width":"25%"}'>
				<div class="echarts4">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="hotvideoChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="hotvideoChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts6">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="hotvideoChart6" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
		...
		methods:{
				...
				this.$confirm(`是否进行数据预测?`, "提示", {
					...
					this.$http({
						...
						if(res.data&&res.data.code==0){
							...
							this.$http({
								url: 'hotvideoforecast/forecast',
								method: 'post',
								data: this.forecastForm
							}).then(obj=>{
								if(obj.data&&obj.data.code==0){
									this.$http({
										url: 'hotvideoforecast/info/' + res.data.data,
										method: 'get'
									}).then(rs2=>{
			...
			gethotvideoList() {
				...
				this.$http({
					...
					if (data && data.code === 0) {
						this.hotvideoList = data.data.list;
						let div = document.getElementById('hotvideoTable')
						var scrollTop = -1
						function move() {
							if (div){
						...
						this.hotvideoTimer = setInterval(move, 2000);
						div.addEventListener('mouseenter', e => {
							e.stopPropagation()
							clearInterval(this.hotvideoTimer);
						})
			...
			hotvideoChat1() {
				this.$nextTick(()=>{
					...
					var hotvideoChart1 = echarts.init(document.getElementById("hotvideoChart1"),'macarons');
					this.$http({
						url: `hotvideo/value/title/duration`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							hotvideoChart1.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								hotvideoChart1.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			hotvideoChat2() {
				this.$nextTick(()=>{
					...
					var hotvideoChart2 = echarts.init(document.getElementById("hotvideoChart2"),'macarons');
					this.$http({
						url: `hotvideo/value/title/playcount`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							hotvideoChart2.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								hotvideoChart2.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			hotvideoChat3() {
				this.$nextTick(()=>{
					...
					var hotvideoChart3 = echarts.init(document.getElementById("hotvideoChart3"),'macarons');
					this.$http({
						url: `hotvideo/value/title/danmaku`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							hotvideoChart3.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								hotvideoChart3.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			hotvideoChat4() {
				this.$nextTick(()=>{
					...
					var hotvideoChart4 = echarts.init(document.getElementById("hotvideoChart4"),'macarons');
					this.$http({
						url: `hotvideo/value/title/likes`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							hotvideoChart4.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								hotvideoChart4.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			hotvideoChat5() {
				this.$nextTick(()=>{
					...
					var hotvideoChart5 = echarts.init(document.getElementById("hotvideoChart5"),'macarons');
					this.$http({
						url: `hotvideo/value/title/favorite`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							hotvideoChart5.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								hotvideoChart5.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			hotvideoChat6() {
				this.$nextTick(()=>{
					...
					var hotvideoChart6 = echarts.init(document.getElementById("hotvideoChart6"),'macarons');
					this.$http({
						url: `hotvideo/value/title/share`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							hotvideoChart6.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								hotvideoChart6.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			hotvideoChat7() {
				this.$nextTick(()=>{
					...
					var hotvideoChart7 = echarts.init(document.getElementById("hotvideoChart7"),'macarons');
					this.$http({
						url: `hotvideo/value/title/coin`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							hotvideoChart7.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								hotvideoChart7.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			hotvideoChat8() {
				this.$nextTick(()=>{
					...
					var hotvideoChart8 = echarts.init(document.getElementById("hotvideoChart8"),'macarons');
					this.$http({
						url: "hotvideo/group/author",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							hotvideoChart8.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								hotvideoChart8.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			hotvideoChat9() {
				this.$nextTick(()=>{
					...
					var hotvideoChart9 = echarts.init(document.getElementById("hotvideoChart9"),'macarons');
					this.$http({
						url: "hotvideo/group/typename",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							hotvideoChart9.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								hotvideoChart9.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			gethotvideoforecastCount() {
				this.$http({
					url: `hotvideoforecast/count`,
					method: "get"
				}).then(({
					data
				}) => {
					if (data && data.code == 0) {
						this.hotvideoforecastCount = data.data
					}
				})
			},
		}
