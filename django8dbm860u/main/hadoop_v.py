...
def upload_csv_mapreduce_hadoop():
    # 查询数据
    query = "SELECT * FROM hotvideo"
    df = pd.read_sql(query, connection)
    local_csv_path = os.path.join(parent_directory,"hotvideo.csv")
    # 导出为 CSV 文件
    df.to_csv(local_csv_path, index=False)
    print(f"数据成功导出到 CSV 文件: {local_csv_path}")
    hdfs_csv_path = '/input/hotvideo.csv'
    # 目标 HDFS 路径
...
def send_cmd():
    ...
    [
        ...
        "-mapper", f"\"python value_mapper.py {csv_index('hotvideo.csv','title')} {csv_index('hotvideo.csv','duration')} 无  \"",
        "-reducer", "\"python value_reducer.py title\"",
        "-input", "hdfs://localhost:9000/input/hotvideo.csv",
        "-output", "hdfs://localhost:9000/output/hotvideo/valuetitleduration"
    ],
    [
        f"{hadoop_path}/bin/hadoop.cmd", "jar", f"{hadoop_path}/share/hadoop/tools/lib/hadoop-streaming-3.3.0.jar",
        "-files", "\"hdfs://localhost:9000/input/value_mapper.py,hdfs://localhost:9000/input/value_reducer.py\"",
        "-mapper", f"\"python value_mapper.py {csv_index('hotvideo.csv','title')} {csv_index('hotvideo.csv','playcount')} 无  \"",
        "-reducer", "\"python value_reducer.py title\"",
        "-input", "hdfs://localhost:9000/input/hotvideo.csv",
        "-output", "hdfs://localhost:9000/output/hotvideo/valuetitleplaycount"
    ],
    [
        f"{hadoop_path}/bin/hadoop.cmd", "jar", f"{hadoop_path}/share/hadoop/tools/lib/hadoop-streaming-3.3.0.jar",
        "-files", "\"hdfs://localhost:9000/input/value_mapper.py,hdfs://localhost:9000/input/value_reducer.py\"",
        "-mapper", f"\"python value_mapper.py {csv_index('hotvideo.csv','title')} {csv_index('hotvideo.csv','danmaku')} 无  \"",
        "-reducer", "\"python value_reducer.py title\"",
        "-input", "hdfs://localhost:9000/input/hotvideo.csv",
        "-output", "hdfs://localhost:9000/output/hotvideo/valuetitledanmaku"
    ],
    [
        f"{hadoop_path}/bin/hadoop.cmd", "jar", f"{hadoop_path}/share/hadoop/tools/lib/hadoop-streaming-3.3.0.jar",
        "-files", "\"hdfs://localhost:9000/input/value_mapper.py,hdfs://localhost:9000/input/value_reducer.py\"",
        "-mapper", f"\"python value_mapper.py {csv_index('hotvideo.csv','title')} {csv_index('hotvideo.csv','likes')} 无  \"",
        "-reducer", "\"python value_reducer.py title\"",
        "-input", "hdfs://localhost:9000/input/hotvideo.csv",
        "-output", "hdfs://localhost:9000/output/hotvideo/valuetitlelikes"
    ],
    [
        f"{hadoop_path}/bin/hadoop.cmd", "jar", f"{hadoop_path}/share/hadoop/tools/lib/hadoop-streaming-3.3.0.jar",
        "-files", "\"hdfs://localhost:9000/input/value_mapper.py,hdfs://localhost:9000/input/value_reducer.py\"",
        "-mapper", f"\"python value_mapper.py {csv_index('hotvideo.csv','title')} {csv_index('hotvideo.csv','favorite')} 无  \"",
        "-reducer", "\"python value_reducer.py title\"",
        "-input", "hdfs://localhost:9000/input/hotvideo.csv",
        "-output", "hdfs://localhost:9000/output/hotvideo/valuetitlefavorite"
    ],
    [
        f"{hadoop_path}/bin/hadoop.cmd", "jar", f"{hadoop_path}/share/hadoop/tools/lib/hadoop-streaming-3.3.0.jar",
        "-files", "\"hdfs://localhost:9000/input/value_mapper.py,hdfs://localhost:9000/input/value_reducer.py\"",
        "-mapper", f"\"python value_mapper.py {csv_index('hotvideo.csv','title')} {csv_index('hotvideo.csv','share')} 无  \"",
        "-reducer", "\"python value_reducer.py title\"",
        "-input", "hdfs://localhost:9000/input/hotvideo.csv",
        "-output", "hdfs://localhost:9000/output/hotvideo/valuetitleshare"
    ],
    [
        f"{hadoop_path}/bin/hadoop.cmd", "jar", f"{hadoop_path}/share/hadoop/tools/lib/hadoop-streaming-3.3.0.jar",
        "-files", "\"hdfs://localhost:9000/input/value_mapper.py,hdfs://localhost:9000/input/value_reducer.py\"",
        "-mapper", f"\"python value_mapper.py {csv_index('hotvideo.csv','title')} {csv_index('hotvideo.csv','coin')} 无  \"",
        "-reducer", "\"python value_reducer.py title\"",
        "-input", "hdfs://localhost:9000/input/hotvideo.csv",
        "-output", "hdfs://localhost:9000/output/hotvideo/valuetitlecoin"
    ],
    [
        f"{hadoop_path}/bin/hadoop.cmd", "jar", f"{hadoop_path}/share/hadoop/tools/lib/hadoop-streaming-3.3.0.jar",
        "-files", "\"hdfs://localhost:9000/input/group_mapper.py,hdfs://localhost:9000/input/group_reducer.py\"",
        "-mapper", f"\"python group_mapper.py {csv_index('hotvideo.csv','author')}\"",
        "-reducer", "\"python group_reducer.py author\"",
        "-input", "hdfs://localhost:9000/input/hotvideo.csv",
        "-output", "hdfs://localhost:9000/output/hotvideo/groupauthor"
    ],
    [
        f"{hadoop_path}/bin/hadoop.cmd", "jar", f"{hadoop_path}/share/hadoop/tools/lib/hadoop-streaming-3.3.0.jar",
        "-files", "\"hdfs://localhost:9000/input/group_mapper.py,hdfs://localhost:9000/input/group_reducer.py\"",
        "-mapper", f"\"python group_mapper.py {csv_index('hotvideo.csv','typename')}\"",
        "-reducer", "\"python group_reducer.py typename\"",
        "-input", "hdfs://localhost:9000/input/hotvideo.csv",
        "-output", "hdfs://localhost:9000/output/hotvideo/grouptypename"
    ],
    ]
