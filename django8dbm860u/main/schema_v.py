...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spiderelr12v47 && scrapy crawl "+tableName+"Spider -a databaseName=django8dbm860u"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=django8dbm860u"
        os.system(cmd)
